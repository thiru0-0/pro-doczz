...
import ReactNotFound from '@/pages/NotFound';
...
export default function CreateRouter() {
  ...
  switch(id) {
    ...
    case 'proposal': return <ProposalWizard />;
    case 'contract': return <ContractWizard />;
    case 'nda': return <NDAWizard />;
    case 'legal': return <LegalGenericWizard />;
    case 'report': return <ReportWizard />;
    case 'invoice': return <InvoiceWizard />;
    case 'job': return <JobDescriptionWizard />;
    case 'cover': return <CoverLetterWizard />;
    case 'sales-pitch': return <SalesPitchWizard />;
    case 'analysis': return <AnalysisWizard />;
    default: return <ReactNotFound />;
  }
}
